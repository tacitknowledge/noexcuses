...
/**
 * Created by IntelliJ IDEA. User: mshort Date: May 3, 2011 Time: 9:39:57 AM To
...
public class SampleTest {
	...
	@Test
	public void testGetterAndSetterConvenienceMethodWithExclusions()
			throws Exception {
		DummyObject object = new DummyObject("Something", "another", true);
		MethodTester methodTester = new MethodTester();
		methodTester.performGettersAndSetters(object,
				new String[] { "getSomething" });

	}

	@Test
	public void testAllMethodsExceptAttemptAndThrowAnException()
			throws Exception {
		DummyObject object = new DummyObject("Something", "another", true);
		MethodTester methodTester = new MethodTester("", new String[] {
				"attempt", "throwAnException" }, null,
